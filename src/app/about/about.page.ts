  ...
  members = [
    {
      ...
      bio: 'Full-Stack Web Developer combining exemplary communication and analytical skills with a notable track record in the non-profit sector, CRMs, and databases. Exhibits organizational skills honed through professional experience juggling multiple projects, both in collaborative teams and autonomous settings. Adept at troubleshooting with a natural aptitude for problem-solving.'
    },
    {
      name: 'Kristin Bailey',
